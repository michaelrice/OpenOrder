	...
	<body>
		...
		<div id="show-item" class="content scaffold-show" role="main">
			...
			<ol class="property-list item">
				...
				<li class="fieldcontain">
					<span id="thumbnailImage-label" class="property-label"><g:message code="item.thumbnailImage.label" default="Thumbnail Image" /></span>
				...
				<li class="fieldcontain">
					<span id="cart-label" class="property-label"><g:message code="item.cart.label" default="Cart" /></span>
						...
						<span class="property-value" aria-labelledby="cart-label"><g:link controller="cart" action="show" id="${itemInstance?.cart?.id}">${itemInstance?.cart?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="category-label" class="property-label"><g:message code="item.category.label" default="Category" /></span>
						...
						<span class="property-value" aria-labelledby="category-label"><g:link controller="category" action="show" id="${itemInstance?.category?.id}">${itemInstance?.category?.name}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="featuredItem-label" class="property-label"><g:message code="item.featuredItem.label" default="Featured Item" /></span>
					
						<span class="property-value" aria-labelledby="featuredItem-label"><g:formatBoolean boolean="${itemInstance?.featuredItem}" /></span>
				...
				<li class="fieldcontain">
					<span id="isOnSale-label" class="property-label"><g:message code="item.isOnSale.label" default="Is On Sale" /></span>
					
						<span class="property-value" aria-labelledby="isOnSale-label"><g:formatBoolean boolean="${itemInstance?.isOnSale}" /></span>
				...
				<li class="fieldcontain">
					<span id="orderLimit-label" class="property-label"><g:message code="item.orderLimit.label" default="Order Limit" /></span>
					
						<span class="property-value" aria-labelledby="orderLimit-label"><g:fieldValue bean="${itemInstance}" field="orderLimit"/></span>
				...
				<li class="fieldcontain">
					<span id="splitable-label" class="property-label"><g:message code="item.splitable.label" default="Splitable" /></span>
					
						<span class="property-value" aria-labelledby="splitable-label"><g:formatBoolean boolean="${itemInstance?.splitable}" /></span>
				...
				<li class="fieldcontain">
					<span id="vendor-label" class="property-label"><g:message code="item.vendor.label" default="Vendor" /></span>
					
						<span class="property-value" aria-labelledby="vendor-label"><g:link controller="vendor" action="show" id="${itemInstance?.vendor?.id}">${itemInstance?.vendor?.name}</g:link></span>
